...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # tarefas. Ela decide verificar sua homepage
        ...
        # Ela digita "Buy peacock feathers" (Comprar penas de pavão) em uma caixa de
        # texto (o hobby de Edith é fazer iscas para pesca em fly)
        ...
        # Satisfeita, ela voltar a dormir
